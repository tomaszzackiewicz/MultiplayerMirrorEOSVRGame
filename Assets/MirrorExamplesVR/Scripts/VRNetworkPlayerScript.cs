...
public class VRNetworkPlayerScript : NetworkBehaviour
{
    ...
    void Awake()
    {
        if (headModel != null)
        {
            headRenderer = headModel.GetComponent<Renderer>();
        }
    }
    ...
    public override void OnStartLocalPlayer()
    {
        ...
        {
            CmdSetupPlayer("Player: " + netId, randomColor);
        }
        else
        {
            CmdSetupPlayer(VRStaticVariables.playerName, randomColor);
        }
    }
    ...
    [Command]
    public void CmdSetupPlayer(string _name, Color color)
    {
