...
public class VRNetworkManager : NetworkManager
{
    ...
    public override void OnServerConnect(NetworkConnectionToClient conn)
    {
        ...
        if (EOSAutoConnector.Instance != null)
        {
            EOSAutoConnector.Instance.SetupInfoText("A client connected.");
            EOSAutoConnector.Instance.SetupInfoText($"A client connected: {conn.address}");
        }
    }
    ...
    public override void OnServerDisconnect(NetworkConnectionToClient conn)
    {
        ...
        if (EOSAutoConnector.Instance != null)
        {
            EOSAutoConnector.Instance.SetupInfoText("A client disconnected.");
        }
    }
    ...
    public override void OnServerError(NetworkConnectionToClient conn, TransportError transportError, string message)
    {
        ...
        if (EOSAutoConnector.Instance != null)
        {
            EOSAutoConnector.Instance.SetupInfoText("OnServerError: " + message);
        }
    }
    ...
    public override void OnClientConnect()
    {
        ...
        if (EOSAutoConnector.Instance != null)
        {
            EOSAutoConnector.Instance.SetupInfoText("Connected to server.");
        }
    }
    ...
    public override void OnClientDisconnect()
    {
        ...
        if (EOSAutoConnector.Instance != null)
        {
            EOSAutoConnector.Instance.SetupInfoText("Disconnected from server.");
        }
    }
    ...
    public override void OnClientError(TransportError transportError, string message)
    {
        ...
        if (EOSAutoConnector.Instance != null)
        {
            EOSAutoConnector.Instance.SetupInfoText("OnClientError: " + message);
        }
    }
    ...
    public override void OnStartServer()
    {
        ...
        if (EOSAutoConnector.Instance != null)
        {
            EOSAutoConnector.Instance.SetupInfoText("Started server.");
            EOSAutoConnector.Instance.SetupInfoText("Server started successfully!");
        }
    }
    ...
    public override void OnStartClient()
    {
        ...
        if (EOSAutoConnector.Instance != null)
        {
            EOSAutoConnector.Instance.SetupInfoText("Client started.");
        }
    }
    ...
    public override void OnStopServer()
    {
        ...
        if (EOSAutoConnector.Instance != null)
        {
            EOSAutoConnector.Instance.SetupInfoText("Server stopped.");
        }
    }
    ...
    public override void OnStopClient()
    {
        ...
        if (EOSAutoConnector.Instance != null)
        {
            EOSAutoConnector.Instance.SetupInfoText("Client stopped.");
        }
    }
