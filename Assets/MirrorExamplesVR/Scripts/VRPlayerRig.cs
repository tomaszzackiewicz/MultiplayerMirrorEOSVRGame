...
public class VRPlayerRig : MonoBehaviour
{
    ...
    private void Update()
    {
        if (localVRNetworkPlayerScript)
        {
            ...
            localVRNetworkPlayerScript.headTransform.localPosition = this.headTransform.localPosition;
            localVRNetworkPlayerScript.headTransform.localRotation = this.headTransform.localRotation;
            localVRNetworkPlayerScript.rHandTransform.localPosition = this.rHandTransform.localPosition;
            localVRNetworkPlayerScript.rHandTransform.localRotation = this.rHandTransform.localRotation;
            localVRNetworkPlayerScript.lHandTransform.localPosition = this.lHandTransform.localPosition;
            localVRNetworkPlayerScript.lHandTransform.localRotation = this.lHandTransform.localRotation;
        }
    }
